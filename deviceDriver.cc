/**
 * @file   gMatrix.c
 * @author Valeria Zamora, Francisco, jim
 * @date   November 2018
 * @version 0.1
 * @brief   Martix device.
...
#define  CLASS_NAME  "gMatrix"        ///< The device class -- this is a character device driver
 
MODULE_LICENSE("GPL");            ///< The license type -- this affects available functionality
MODULE_AUTHOR("Valeria Zamora");    ///< The author -- visible when you use modinfo
MODULE_DESCRIPTION("GMatrix");  ///< The description -- see modinfo
